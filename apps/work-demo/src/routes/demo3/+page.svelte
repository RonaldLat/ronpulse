<header>
	<nav class="bg-gray-200 container mx-auto sm:px-4 px-3 flex justify-between items-center">
		<div class="nav--logo">
			<img
		...
		<div class="nav--menu hidden lg:block">
			<a class="mx-2 font-semibold text-gray-700 hover:text-teal-600" href="/">Our Services</a>
			<a class="mx-2 font-semibold text-gray-700 hover:text-teal-600" href="/">About</a>
			<a class="mx-2 font-semibold text-gray-700 hover:text-teal-600" href="/">News & Events</a>
			<a class="mx-2 font-semibold text-gray-700 hover:text-teal-600" href="/">Contact</a>
		</div>
...
<main class="bg-gray">
				...
				<div class="flex mb-4 h-full items-center">
					<div class="w-full lg:w-1/2 text-white font-roboto">
						...
						<p class="font-light text-lg">
							SCH is the most experienced stevedore in the Port of Southampton and our cargo
							operations are further enhanced by our own dedicated warehouse close to the Port,
							providing secure storage supplemented by efficient stock management and distribution.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="container mx-auto h-full px-3 sm:px-4">
			...
			<div class="flex mb-4 flex-wrap shadow-2xl border-light-gray text-main-blue text-center">
				...
				>
					...
					<a href="/"
						><p class="text-teal-400 hover:text-teal-500 font-semibold text-lg">
							See our solution
						</p></a
					>
				</div>
				...
				>
					...
					<a href="/"
						><p class="text-teal-400 font-semibold text-lg hover:text-teal-500">
							See our solution
						</p></a
					>
				</div>
				...
				>
					<img
						src="https://img.icons8.com/ios-filled/75/2d3091/commercial-development-management.png"
					/>
			...
			<div class="flex mb-4 h-full w-full flex-col sm:flex-row">
				...
				<div class="w-full md:w-4/12 relative">
					<a href="">
						...
						>
							<h3 class="font-semibold text-main-blue text-lg mb-4 font-regular">LATEST NEWS</h3>
							<h4 class="text-2xl font-semibold tracking-tight text-gray-900 mb-4">
								SUMMER OF CRUISE SHIP FIRSTS AT LIVERPOOL
							</h4>
							<p class="text-gray-700">
								Stevedores and port terminal management specialists SCH have been awarded the
								contract for a further three years with Liverpool City Council to handle all cruise
								ships calling at Liverpool Cruise Terminal (LCT).
							</p>
						</div>
					</a>
				</div>
				...
				<div class="w-full md:w-1/2 relative order-2 md:order-2">
					<a href="">
						...
						>
							...
							<h4 class="text-3xl font-semibold tracking-tight text-gray-900 mb-4">
								Working with us
							</h4>
							<p class="text-gray-700 mb-4">
								Our expertise extends from receiving and managing cargo at the quayside to ship
								planning and the subsequent loading, discharge and distribution of cargoes.
							</p>
	...
	<section class="section--case-study w-full py-16 relative shadow-full">
		<div class="absolute h-full w-full top-0 left-0 bg-hero-gradient z-1">
			<div class="container mx-auto h-full w-full relative px-3 sm:px-4">
				<a href="">
					<div
					...
					>
						<h3 class="font-semibold text-main-blue text-lg mb-4 font-regular">CASE STUDY</h3>
						<h4 class="text-3xl font-semibold tracking-tight text-gray-900 mb-4">
						...
						<p class="text-teal-400 font-semibold text-lg">More information</p>
					</div>
				</a>
			</div>
		</div>
