<script>
	import { GlowingGradientBtn } from '@repo/ui';
	import { onMount } from 'svelte';

	/** @type {import('./$types').PageData} */
	export let data;

	console.log(data.details.uvp);
	const business = data.details.uvp[0];

	/**@type {HTMLElement}*/
	let hamburger;
	/**@type {HTMLElement[]} array of html elements*/
	let toggles = [];
	$: console.log(toggles);

	/**@param {HTMLElement} node*/
	function collectElement(node) {
		toggles.push(node);

		return {
			destroy() {
				// toggles=toggles.filter(el=> !==node)
			}
		};
	}
...
<nav class="flex flex-wrap items-center justify-between p-3 bg-[#e8e8e5]">
	<div class="text-xl">Welcome to {business.name}</div>
	<div class="flex md:hidden">
		<button id="hamburger" bind:this={hamburger}>
			<img
				class="toggle block"
	...
	>
		...
		<a href="#contactUs" class="block md:inline-block hover:text-blue-500 px-3 py-3 md:border-none"
			>Visit Us
		</a>
	</div>
...
<div class="relative w-full h-[320px]" id="home">
	...
	<div class="absolute inset-9 flex flex-col md:flex-row items-center justify-between">
		<div class="md:w-1/2 mb-4 md:mb-0">
			<h1 class="text-grey-700 capitalize font-medium text-4xl md:text-5xl leading-tight mb-2">
				{business.name}
			</h1>
			<p class="font-regular text-xl mb-8 mt-4">{business.slogan}</p>
			<a
				href="#contactUs"
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
			...
			<div class="bg-white rounded-lg shadow-md overflow-hidden">
				...
				<div class="p-6 text-center">
					...
					<p class="text-gray-700 text-base">
						...
						snacks. It is also a good source of protein and fiber.Our gram flour grinding service is
						a convenient and affordable way to get the freshest gram flour possible.
					</p>
				</div>
			</div>
			<div class="bg-white rounded-lg shadow-md overflow-hidden">
				...
				<div class="p-6 text-center">
					...
					<p class="text-gray-700 text-base">
						Our jowar grinding service is a convenient and affordable way to get fresh, high-quality
						jowar flour. We use state-of-the-art equipment to grind jowar into a fine powder, which
						is perfect for making roti, bread, and other dishes.
						<details>
			...
			<div class="bg-white rounded-lg shadow-md overflow-hidden">
				...
				<div class="p-6 text-center">
					...
					<p class="text-gray-700 text-base">
						We specializes in the production of high-quality chili powder. Our chili powder is made
						from the finest, freshest chilies, and we use traditional pounding methods to ensure
			...
			>
				...
				<div class="p-6 bg-white text-center rounded-b-lg md:min-h-full">
					...
					<p class="text-gray-700 text-base">
						...
						your taste buds. We use only the freshest ingredients Our flavors include: Mango, spinach
					</p>
				</div>
			</div>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
			<div class="max-w-lg">
				...
				<p class="mt-4 text-gray-600 text-lg">
					Bappa flour mill provides our customers with the highest quality products and services. We
					offer a wide variety of flours and spices to choose from, and we are always happy to help
					our customers find the perfect products for their needs. We are committed to providing our
					customers with the best possible experience. We offer competitive prices, fast shipping,
					and excellent customer service. We are also happy to answer any questions that our
					customers may have about our products or services. If you are looking for a flour and
					spices service business that can provide you with the highest quality products and
					services, then we are the company for you. We look forward to serving you!
				</p>
			</div>
...
<section class="text-gray-700 body-font" id="gallery">
	<div class="flex justify-center text-3xl font-bold text-gray-800 text-center py-10">Gallery</div>
